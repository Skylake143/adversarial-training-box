...
def main():
    ...
    source_models = ["/CIFAR/CIFAR10Resnet18Batch128_10-11-2025+18_09/resnet18.pth"]#["/cnn_madry_medium-pgd-training_21-10-2025+12_40/cnn_madry_medium.pth"]
    base_path="/home/s3665534/adversarial-training-box-FORK/generated/BachelorThesisRuns"

    job_configs = []
    
    for source_model in source_models:
        source_model_path = base_path + source_model
