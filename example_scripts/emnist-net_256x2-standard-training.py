...
def objective(trial):
    ...
    dataset = torchvision.datasets.EMNIST('../data', train=True, download=False, transform=torchvision.transforms.ToTensor())
...
if __name__ == "__main__":
    ...
    # Setup experiment
    experiment_tracker = ExperimentTracker("emnist_net_256x2-standard-training", Path("./generated"), login=True)
