...
def objective(trial):
    network = EMNIST_NET_256x2() # Can you automate this by keeping the network variable??
    ...
    dataset = torchvision.datasets.EMNIST('../data', split="balanced",train=True, download=False, transform=torchvision.transforms.ToTensor())
...
if __name__ == "__main__":
    ...
    # Setup experiment
    experiment_tracker = ExperimentTracker("emnist_net_256x2-pgd-training", Path("./generated"), login=True)
