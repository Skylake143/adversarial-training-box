...
if __name__ == "__main__":
    ...
    # Setup experiment
    experiment_tracker = ExperimentTracker("emnist_relu_4_1024-pgd-training", Path("./generated"), login=True)
    experiment_tracker.initialize_new_experiment("", training_parameters=training_parameters | training_objects)
    #TODO: scheduler None
    pipeline = Pipeline(experiment_tracker, training_parameters, criterion, optimizer, None)
