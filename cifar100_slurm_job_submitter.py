...
def main():
    ...
    for network in networks:
        config = SlurmJobConfig(
            job_name=f"cifar100_standard_{network.lower()}",
            script_path="example_scripts/CIFAR/cifar100-standard-training.py",
            partition="gpu-short", # gpu-short;gpu-2080ti-11g; gpu-mig-40g; gpu-a100-80g; gpu-l4-24g
            time_limit="04:00:00"
        )
        args = f"--network {network} --experiment_name cifar100-{network.lower()}-standard-training"
